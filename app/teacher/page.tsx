            ...
            <Card className="lg:col-span-2">
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  <Link href="/teacher/doubts" className="p-4 border-2 border-yellow-200 rounded-lg hover:bg-yellow-50 transition-colors">
                  ...
                  <Link href="/teacher/materials" className="p-4 border-2 border-blue-200 rounded-lg hover:bg-blue-50 transition-colors">
