            ...
            <Card className="lg:col-span-2">
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  <Link href="/student/chat" className="p-4 border-2 border-blue-200 rounded-lg hover:bg-blue-50 transition-colors">
                  ...
                  <Link href="/student/doubts" className="p-4 border-2 border-green-200 rounded-lg hover:bg-green-50 transition-colors">
                  ...
                  <Link href="/student/materials" className="p-4 border-2 border-purple-200 rounded-lg hover:bg-purple-50 transition-colors">
                  ...
                  <Link href="/student" className="p-4 border-2 border-orange-200 rounded-lg hover:bg-orange-50 transition-colors">
